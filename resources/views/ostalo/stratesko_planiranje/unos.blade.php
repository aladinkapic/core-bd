                ...
                <div class="container_block">
                    <div class="split_container">
                        <div class="form-group row">
                            <div class="col">
                                {!! Form::label('naziv', __('Naziv').' : ', ['class' => 'control-label']) !!}
                                <div class="col-lg-12">
                                    {!! Form::text('naziv', isset($sp) ? $sp->naziv : '', ['class' => 'form-control', 'rows' => 1, 'autocomplete' => 'off', 'maxlength' => 255, isset($id) ? 'readonly' : '']) !!}
                                </div>
                            </div>
                            <div class="col">
                                {!! Form::label('br_plan_godina', __('Broj planiranih godina').' : ', ['class' => 'control-label']) !!}
                                <div class="col-lg-12">
                        ...
                        <div class="form-group row">
                            <div class="col">
                                {!! Form::label('id_rm', __('Radno mjesto').' : ', ['class' => 'control-label']) !!}
                                <div class="col-lg-12">
                                    {!!  Form::select('id_rm', $radna_mjesta, isset($sp) ? $sp->id_rm : '' ,['class' => 'form-control', isset($id) ? 'disabled  = "true"' : '']) !!}
                                </div>
                            </div>
                            <div class="col">
                                {!! Form::label('id_oju', __('Organ javne uprave').' : ', ['class' => 'control-label']) !!}
                                <div class="col-lg-12">
                        ...
                        <div class="form-group row">
                            <div class="col">
                                {!! Form::label('datum_broj', __('Datum i broj akta').' : ', ['class' => 'control-label']) !!}
                                <div class="col-lg-12">
                    ...
                    <div class="split_container">
                        <div class="form-group row">
                            <div class="col">
                                {!! Form::label('pb_neodredjeno', __('Postojeći broj na neodređeno').' : ', ['class' => 'control-label']) !!}
                                <div class="col-lg-12">
                            ...
                            <div class="col">
                                {!! Form::label('pb_odredjeno', __('Postojeći broj na određeno').' : ', ['class' => 'control-label']) !!}
                                <div class="col-lg-12">
                        ...
                        <div class="form-group row">
                            <div class="col">
                                {!! Form::label('pb_prekobrojnih', __('Postojeći broj prekobrojnih').' : ', ['class' => 'control-label']) !!}
                                <div class="col-lg-12">
                            ...
                            <div class="col">
                                {!! Form::label('pb_godina', __('Postojeći broj - godina').' : ', ['class' => 'control-label']) !!}
                                <div class="col-lg-12">
                        ...
                        <div class="form-group row">
                            <div class="col">
                                {!! Form::label('pot_b_neodredjeno', __('Potreban broj na neodređeno vrijeme').' : ', ['class' => 'control-label']) !!}
                                <div class="col-lg-12">
                            ...
                            <div class="col">
                                {!! Form::label('pot_b_odredjeno', __('Potreban broj na određeno').' : ', ['class' => 'control-label']) !!}
                                <div class="col-lg-12">
                        ...
                        <div class="form-group row">
                            <div class="col">
                                {!! Form::label('pot_b_godina', __('Potreban broj godina').' : ', ['class' => 'control-label']) !!}
                                <div class="col-lg-12">
