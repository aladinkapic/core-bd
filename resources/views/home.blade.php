                ...
                <div class="col-md-4">
                    @foreach($notifications as $notification)
                        <div class="alert alert-danger my-custom-alert" role="alert" id="notification-id-{{$notification->sluzbenik->id ?? '1'}}">
                            <a href="{{route('drzavni-sluzbenici.pregled-sluzbenika', ['id' => $notification->toWho->id ?? '/'])}}">{{$notification->toWho->ime ?? '/'}} {{$notification->toWho->prezime ?? '/'}}</a>
                    ...
                    <div class="card bg-light">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <span class="badge badge-primary badge-pill">{{$brojZaPenzionisanje}}</span>
                            </li>
{{--                            <li class="list-group-item d-flex justify-content-between align-items-center">--}}
