...
{{--                                    </div>--}}
                                    ...
                                    <div class="form-group row">
                                        <div class="col">
                                            ...
                                            <div class="col-lg-12">
                                                {!!  Form::select('strucna_sprema', $kompetencije, isset($radno_mjesto) ? $radno_mjesto->strucna_sprema : '' ,['class' => 'form-control', 'id' => 'strucna_sprema', isset($radno_mjesto) ? 'disabled  = "true"' : '']) !!}
                                            </div>
                                        </div>
{{--                                        <div class="col">--}}
