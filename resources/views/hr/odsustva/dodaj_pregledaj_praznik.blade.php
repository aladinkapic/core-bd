...
@section('title') {{__('Dodajte / Pregledajte praznike')}} @stop
            ...
            <div class="steps-wizard" style="width:100%; margin-left:10px;">
                <ul class="four">
                    <li class="{{ Request::path() == 'hr/odsustva/praznici/dodaj' ? 'active' : '' }} single_bar ">
                        ...
                        <a href="{{asset('/hr/odsustva/praznici/dodaj')}}">{{__('Dodajte novi praznik')}}</a>
                    </li>
                    <li class="{{ Request::path() == 'hr/odsustva/uredi_praznik' ? 'active' : '' }} single_bar ">
                        <i class="fas fa-edit"></i>
                        <a href="/hr/odsustva/uredi_praznik">{{__('Uredite praznike')}}</a>
                    </li>
                    <li class="{{ Request::path() == 'hr/odsustva/pregled_praznika' ? 'active' : '' }} single_bar ">
                        <i class="far fa-calendar-alt"></i>
                        <a href="/hr/odsustva/pregled_praznika">{{__('Pregled svih praznika')}}</a>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="row">
                        ...
                        @csrf <!-- {{ csrf_field() }} -->
                            <div class="col-md-12">
                                ...
                                <button style="float:right;" class="btn btn-dark" ><i class="fa fa-plus"></i> {{__('Dodajte praznik')}}</button>
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        @csrf <!-- {{ csrf_field() }} -->
                            <div class="col-md-12">
                                ...
                                <button style="float:right;" class="btn btn-dark" ><i class="fas fa-edit"></i> {{__('Ažurirajte praznik')}}</button>
                            </div>
                        </form>
                    </div>
                </div>
