...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-10">
                <h4>Evidencija prestanka radnog odnosa </h4>
            ...
            <div class="col-md-2">
                <button class="btn btn-success" style="float:right;" v-on:click="url('{{ route('ugovor.prestanak.create') }}')"> <i class="fa fa-plus fa-1x"></i> Novi unos</button>
            </div>
        </div>
