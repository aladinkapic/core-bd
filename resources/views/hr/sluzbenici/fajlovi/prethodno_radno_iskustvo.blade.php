<div class="drop_down_option">
    <div class="single_row header header2">
        <p>{{__('Radni staž kod prethodnih poslodavaca')}}</p>
...
{{--                            {!! Form::select('poslodavac', $poslodavac, '', ['class' => 'form-control', 'maxlength' => '50', 'rows' => 1, 'id' => 'poslodavac', 'autocomplete' => 'off']) !!}--}}
                ...
                <div class="double_row">
                    ...
                    <div class="single_row">
                        {!! Form::label('radno_vrijeme', __('Vrsta staža').' : ', ['class' => ' control-label'] )  !!}
                        <div class="col-lg-12">
                            {!!  Form::select('radno_vrijeme', ['0' => 'Radni staž', '1' => 'Staž osiguranja'], '0' ,['class' => 'form-control', 'id' => 'radno_vrijeme']) !!}
                        </div>
                    </div>
                </div>
...
{{--                </div>--}}
                ...
                <div class="double_row">
                    <div class="single_row">
                        {!! Form::label('koeficijent', __('Koeficijent').' : ', ['class' => ' control-label'] )  !!}
                        <div class="col-lg-12">
                            {!!  Form::number('koeficijent', '100' ,['class' => 'form-control read_stuffs', 'id' => 'koeficijent', 'maxlength' => '500', 'min' => '0', 'max' => '100', 'autocomplete' => 'off', 'number']) !!}
                        </div>
                    </div>

                    <div class="single_row">
                        {!! Form::label('radno_vrijeme', __('Staž sa uvećanim trajanjem').' : ', ['class' => ' control-label'] )  !!}
                        <div class="col-lg-12">
                            {!!  Form::select('radno_vrijeme', ['0' => 'Nema uvećanja', '1' => '12 / 14', '2' => '12/15', '3' => '12/16'], '0' ,['class' => 'form-control', 'id' => 'radno_vrijeme']) !!}
                        </div>
                    </div>
                </div>
