    ...
    <div class="container">
        ...
        <section class="multi_step_form">
            <div id="msform">
                <!-- Tittle -->
                <div class="tittle">
                    <h2>Novi organizacioni plan</h2>
                    <p>Molimo Vas da popunite sva potrebna polja za unos. Sve aktivnosti na ovoj stranici će biti
                        zabilježene.</p>
                ...
                <form method="POST" action="{{ route('organizacija.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <label for="staticEmail" class="col-sm-3 col-form-label">Organ javne uprave</label>
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <label for="staticEmail" class="col-sm-3 col-form-label">Kopiranje organizacionog plana: </label>
                                            <div class="col-sm-9">
                                                <select class="form-control" name="org_plan" >
                                                    <option value="">Novi organizacioni plan</option>
                    ...
                    <section>
                        ...
                        <div class="card">
                            <div class="card-body">
                                Molimo Vas da priložite dokument - Pravilnik o unutrašnjoj organizaciji sa sistematizacijom radnih mjesta kako bi nastavili sa procesom dodavanja organizacionog plana.
                                ...
                                <div class="text-center">
                                    <div class="custom-file col-md-4">
                                        ...
                                        <label class="custom-file-label" for="customFile"><i class="fa fa-file" style="padding-right: 10px;"></i> Kliknite za odabir dokumenta</label>
                                    </div>
                                </div>
                                ...
                                <div class="text-center">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="defaultCheck1">
                                            <br />Odabirom kvačice potvrđujem da su unesene informacije tačne i u skladu sa priloženim pravilnikom.
                                        </label>
                                    </div>
                                </div>
