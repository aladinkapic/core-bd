...
Route::prefix('hr/odsustva')->group(function () {
    /* praznici */
    Route::get('/izaberite-korisnika',   'SluzbenikController@pregledSluzbenika')->name('odsustva.izaberi');
...
Route::prefix('hr/sluzbenici')->group(function () {
    ...
    Route::get('/zbirni-izvjestaj',    'SluzbenikController@zbirniIZvjestaj')->name('sluzbenik.zbirni-izvjestaj');
...
Route::get('/hr/uprava/viewUprava/{id}',        'UpravaController@show')->name('organ-pregled');
